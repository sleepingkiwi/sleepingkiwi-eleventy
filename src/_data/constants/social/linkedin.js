module.exports = {
  colour: '#0077b5',
  name: 'LinkedIn',
  root: '', // we wask for full URLs for LinkedIn right now...
  icon: {
    width: 32,
    height: 32,
    viewBox: '0 0 32 32',
